...
module.exports = function( grunt ) {
	...
	grunt.initConfig( {
		...
		shell: {
			...
			create_build_zip: {
				command: 'if [ ! -e build ]; then echo "Run grunt build first."; exit 1; fi; if [ -e headless-blocks.zip ]; then rm headless-blocks.zip; fi; cd build; zip -r ../headless-blocks.zip .; cd ..; echo; echo "ZIP of build: $(pwd)/headless-blocks.zip"',
			},
		},
